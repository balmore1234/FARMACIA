...
<div class="contenedor">
    ...
    <div class="col-6 col-t-12">
        ...
        <br> 
        <form class="form-inline" action="${pageContext.servletContext.contextPath}/Categorias" method="get">
            ...
            <div class="form-group mx-sm-2 mb-2">
                <ul>        
                    <a class="btn btn-warning" href="${pageContext.servletContext.contextPath}/Categorias?accion=insertar">Nuevo</a></ul>
            </div>
        </form>
    </div>
