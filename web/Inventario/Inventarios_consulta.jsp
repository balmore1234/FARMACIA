...
<div class="contenedor">
    ...
    <div class="col-6 col-t-12">
        ...
        <br> 
        <form class="form-inline" action="${pageContext.servletContext.contextPath}/Inventarios" method="get">
            ...
            <div class="form-group mx-sm-2 mb-2">
                <ul>        
                    <a class="btn btn-warning" href="${pageContext.servletContext.contextPath}/Inventarios?accion=insertar">Nuevo</a></ul>
            </div>
            <div><a href="${pageContext.servletContext.contextPath}/Reporte_Producto" target="_blank">Ver Reporte</a></div>
        </form>
    </div>
